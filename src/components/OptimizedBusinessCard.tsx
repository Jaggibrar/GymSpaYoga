  ...
  return (
    <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-0 rounded-3xl overflow-hidden bg-white">
      <div className="relative overflow-hidden h-48">
        ...
        <Badge className={`absolute top-4 right-4 bg-gradient-to-r ${getTierColor(business.tier!)} text-white border-0 px-3 py-2 rounded-full`}>
          {getTierIcon(business.tier!)}
          <span className="ml-1 capitalize font-semibold">{business.tier}</span>
        </Badge>
