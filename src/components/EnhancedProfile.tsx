  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="relative">
        {/* Background Pattern */}
        <div className="absolute inset-0 bg-[hsl(var(--primary))]/5 rounded-3xl"></div>
        ...
        <Card className="relative border-0 shadow-xl bg-white/95 backdrop-blur-sm rounded-3xl overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[hsl(var(--primary))]/5 rounded-full -translate-y-48 translate-x-48"></div>
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-[hsl(var(--primary))]/5 rounded-full translate-y-32 -translate-x-32"></div>
          ...
          <CardContent className="relative p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <Badge className="bg-[hsl(var(--primary))] text-white px-4 py-2 rounded-full text-sm font-medium">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-[hsl(var(--primary))]/10 rounded-2xl">
                    <div className="text-2xl font-bold text-[hsl(var(--primary))]">12</div>
                    <div className="text-sm text-[hsl(var(--primary))]/80">Bookings</div>
                  </div>
      ...
      <Card className="border-0 shadow-xl rounded-3xl overflow-hidden bg-white">
        <CardHeader className="bg-gradient-to-r from-gray-50 to-gray-100 p-8">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" className="rounded-xl border-2 hover:border-[hsl(var(--primary))] hover:text-[hsl(var(--primary))] transition-colors">
