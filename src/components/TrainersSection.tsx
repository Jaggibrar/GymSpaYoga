...
const TrainersSection = () => {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case "gym": return "from-[hsl(var(--primary))] to-[hsl(var(--primary))]";
      case "spa": return "from-[hsl(var(--primary))] to-[hsl(var(--primary))]";
      case "yoga": return "from-[hsl(var(--primary))] to-[hsl(var(--primary))]";
      default: return "from-[hsl(var(--primary))] to-[hsl(var(--primary))]";
    }
  };
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-[hsl(var(--primary))]">98%</div>
            ...
            <Card key={trainer.id} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 overflow-hidden transform hover:scale-105 bg-white/90 backdrop-blur-sm">
              <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                  <Badge className={`bg-[hsl(var(--primary))] text-white shadow-lg`}>
              ...
              <CardHeader className="pb-2">
                <CardTitle className="text-lg font-bold text-gray-800 group-hover:text-[hsl(var(--primary))] transition-colors duration-300">
                  {trainer.name}
                </CardTitle>
                <div className="flex justify-between items-center">
                  <p className="text-sm text-gray-600">{trainer.experience} years exp.</p>
                  <p className="text-base sm:text-lg font-bold text-[hsl(var(--primary))]">₹{trainer.hourlyRate}/hr</p>
                </div>
              </CardHeader>
              ...
              <CardContent className="pt-0">
                <div className="space-y-3">
                  ...
                  <Button className="w-full bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))] transform hover:scale-105 transition-all duration-300 text-sm">
                    Book Session
                  </Button>
                </div>
              </CardContent>
        ...
        <div className="text-center">
          <Link to="/trainers">
            <Button size="lg" className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))] text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-6 shadow-xl hover:shadow-2xl transform hover:scale-110 transition-all duration-300 w-full sm:w-auto mb-4 sm:mb-6">
              View All Trainers
          ...
          <div className="mt-4 sm:mt-6">
            <Link to="/register-trainer">
              <Button variant="outline" className="border-[hsl(var(--primary))] text-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/10 text-base sm:text-lg px-6 sm:px-8 py-2 sm:py-3 w-full sm:w-auto">
                Become a Trainer
              </Button>
            </Link>
          </div>
