...
const MotivationOverlay = () => {
  ...
  useEffect(() => {
    ...
    if (!dismissed) {
      // small delay so it appears as a gentle entrance after first paint
  ...
  return (
    ...
    >
      ...
      {/* panel */}
      <ScrollReveal className="relative w-full max-w-xl">
        <div className="relative overflow-hidden rounded-[28px] border border-border/70 bg-card p-8 sm:p-10 shadow-soft">
          {/* decorative glows */}
          ...
          <div className="relative flex flex-col items-start gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <h2
                ...
                className="font-display text-2xl sm:text-[28px] leading-tight font-extrabold text-foreground"
              >
            ...
            <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
              <p>
                Movement is the kindest gift you can give your body. Whether it's a
                morning stretch, an evening session, or simply a calmer breath —
              ...
              <p className="text-foreground/90">
                We're building <span className="font-semibold text-primary">GymSpaYoga</span> into
