  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <Input
        ...
        className="pl-12 pr-4 py-4 text-lg rounded-full border-2 border-gray-200 focus:border-[hsl(var(--primary))] shadow-lg"
      />
      <Button 
        onClick={handleSearch}
        className="absolute right-2 top-1/2 transform -translate-y-1/2 rounded-full bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]"
      >
