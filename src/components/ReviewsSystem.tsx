...
const ReviewsSystem = () => {
  return (
    <div className="space-y-6">
      ...
      {/* Call to Action */}
      <div className="text-center bg-[hsl(var(--primary))] rounded-xl p-8 text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button className="bg-white text-[hsl(var(--primary))] hover:bg-gray-100 font-bold px-8 py-3">
