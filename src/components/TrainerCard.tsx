...
import { MapPin, Phone, Mail, Users, ArrowRight } from 'lucide-react';
    ...
    <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 overflow-hidden transform hover:scale-105 bg-white cursor-pointer">
      ...
      <CardHeader>
        <div className="flex justify-between items-start">
          <div>
            <CardTitle className="text-xl font-bold text-gray-800 group-hover:text-[hsl(var(--primary))] transition-colors duration-300">
              {trainer.name}
            </CardTitle>
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-[hsl(var(--primary))]">₹{trainer.hourly_rate}</p>
      ...
      <CardContent>
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button 
              className="flex-1 bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))] text-white"
