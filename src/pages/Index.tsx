...
const Index = () => {
  ...
  return (
    <div className="min-h-screen w-full">
            ...
            <header>
              <div className="mb-4 sm:mb-6 flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-white/90">
                <div className="flex items-center gap-1 sm:gap-2 bg-white/10 backdrop-blur-sm rounded-full px-2 sm:px-4 py-1 sm:py-2">
                  <Shield className="h-3 w-3 sm:h-5 sm:w-5 text-emerald-400" />
                  <span className="text-xs sm:text-sm font-bold">25,000+ Success Stories</span>
                </div>
                <div className="flex items-center gap-1 sm:gap-2 bg-white/10 backdrop-blur-sm rounded-full px-2 sm:px-4 py-1 sm:py-2">
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-6 text-white/90 px-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-sm sm:text-base">Instant Booking</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-400" />
                    <span className="font-semibold text-sm sm:text-base">Verified Partners</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-400" />
                    <span className="font-semibold text-sm sm:text-base">Money-Back Guarantee</span>
                  </div>
                </div>
              </div>

              {/* Urgency Element - Mobile Optimized */}
              <div className="mb-6 sm:mb-8 flex items-center justify-center animate-pulse px-2">
                <div className="bg-red-500 text-white px-3 sm:px-6 py-2 sm:py-3 rounded-full flex items-center gap-1 sm:gap-2 font-black text-sm sm:text-lg shadow-2xl">
                  <Clock3 className="h-4 w-4 sm:h-5 sm:w-5" />
                  <span className="text-center">⚡ FREE Trial Ends in 48 Hours!</span>
                </div>
              </div>
            </header>
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl max-w-5xl mx-auto border-2 border-[#0FFCBE]/50 mx-3 sm:mx-auto">
                <div className="text-center mb-4 sm:mb-6">
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-gray-800 mb-2">
                ...
                <div className="flex flex-col gap-3 sm:gap-4 md:flex-row md:gap-6">
                  <div className="relative flex-1">
                    <Search className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5 sm:h-6 sm:w-6" aria-hidden="true" />
                    <Input
                      placeholder="Search gyms, spas, yoga studios..."
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                      className="pl-10 sm:pl-14 h-12 sm:h-16 text-base sm:text-lg border-2 border-gray-200 focus:border-[#106EBE] focus:ring-4 focus:ring-[#106EBE]/20 rounded-lg sm:rounded-xl bg-white font-medium shadow-sm"
                      aria-label="Search for wellness destinations"
                    />
                  </div>
                  
                  <div className="relative flex-1">
                    <MapPin className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5 sm:h-6 sm:w-6" aria-hidden="true" />
                    <Input
                  ...
                  <Button 
                    ...
                    size="lg"
                    className="h-12 sm:h-16 px-6 sm:px-10 md:px-12 bg-gradient-to-r from-[#106EBE] to-[#0FFCBE] hover:from-[#106EBE]/90 hover:to-[#0FFCBE]/90 text-white font-black rounded-lg sm:rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-base sm:text-lg"
                    aria-label="Search for wellness destinations"
                  >
                    <Search className="h-5 w-5 sm:h-6 sm:w-6 mr-2 sm:mr-3" aria-hidden="true" />
              ...
              <div className="flex flex-col gap-3 sm:gap-4 justify-center px-3 sm:px-0">
                <Link to="/signup" className="w-full sm:w-auto">
                  <Button 
                    size="xl" 
                    className="bg-[#0FFCBE] hover:bg-[#0FFCBE]/90 text-[#106EBE] font-black px-8 sm:px-12 py-4 sm:py-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-lg sm:text-xl w-full sm:w-auto border-4 border-white/50"
                  >
                ...
                <Link to="/pricing" className="w-full sm:w-auto">
                  <Button 
                    size="xl" 
                    variant="outline" 
                    className="border-3 border-white/70 text-white hover:bg-white/20 backdrop-blur-sm font-black px-8 sm:px-12 py-4 sm:py-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-lg sm:text-xl w-full sm:w-auto bg-white/10"
                  >
        ...
        <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 mx-auto max-w-7xl">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <div className="mb-4 sm:mb-6">
              <Badge className="bg-emerald-100 text-emerald-700 px-4 sm:px-6 py-2 sm:py-3 text-base sm:text-lg font-bold">
                🎯 Choose Your Transformation Path
              </Badge>
            </div>
            <h2 id="categories-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-gray-800 mb-4 sm:mb-6">
              Your Journey to
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              <Link key={index} to={category.link} className="group">
                <Card className="overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 sm:hover:-translate-y-4 h-full flex flex-col border-2 hover:border-[#0FFCBE] relative bg-white group-hover:bg-gray-50">
                  {/* Image Section */}
                  <div className="relative h-40 sm:h-48 md:h-56 overflow-hidden flex-shrink-0">
                    ...
                    <div className="absolute top-3 sm:top-4 right-3 sm:right-4">
                      <Badge className="bg-white/90 text-gray-800 font-bold px-2 sm:px-3 py-1 text-xs sm:text-sm">
                        {category.stats}
                      </Badge>
                    </div>
                    
                    <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 text-white">
                      <category.icon className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 mb-2 sm:mb-3 group-hover:scale-110 transition-transform" aria-hidden="true" />
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-black">{category.title}</h3>
                      <p className="text-sm sm:text-lg font-bold opacity-90">{category.benefit}</p>
                    </div>
                  </div>
                  
                  {/* Content Section */}
                  <CardContent className="p-4 sm:p-6 md:p-8 flex-1 flex flex-col justify-between">
                    <p className="text-gray-600 text-base sm:text-lg font-medium leading-relaxed mb-4">{category.description}</p>
                    
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-600 font-bold text-base sm:text-lg">Explore Options</span>
                      <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-600 group-hover:translate-x-2 transition-transform" />
                    </div>
                  </CardContent>
                </Card>
              </Link>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-white w-full relative" aria-labelledby="featured-heading">
        ...
        <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <h2 id="featured-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-gray-800 mb-4 sm:mb-6">
              Most Booked This Week
              <span className="block text-transparent bg-gradient-to-r from-[#106EBE] to-[#0FFCBE] bg-clip-text text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2 sm:mt-3">
                Book Before They're Full!
              </span>
            </h2>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 font-medium max-w-3xl mx-auto px-2">
          ...
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8" role="status" aria-label="Loading featured destinations">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <Card key={i} className="animate-pulse">
                  <div className="h-40 sm:h-48 md:h-56 bg-gray-200 rounded-t-lg"></div>
                  <CardContent className="p-4 sm:p-6 md:p-8">
                    <div className="h-4 sm:h-5 bg-gray-200 rounded mb-3"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              {filteredBusinesses.slice(0, 6).map((business, index) => (
                <Card key={business.id} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 sm:hover:-translate-y-4 border-2 hover:border-[#0FFCBE] bg-white">
                  <div className="relative overflow-hidden h-40 sm:h-48 md:h-56">
                    ...
                    <div className="absolute top-3 sm:top-4 left-3 sm:left-4 flex flex-col gap-2">
                      <Badge className="bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs sm:text-sm">
                        {business.category}
                      </Badge>
                    </div>
                  ...
                  <CardHeader className="pb-2 sm:pb-3 p-4 sm:p-6 md:p-8">
                    ...
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <span className="truncate font-semibold text-sm sm:text-base">{business.city}, {business.state}</span>
                    </div>
                  </CardHeader>
                  ...
                  <CardContent className="pt-0 p-4 sm:p-6 md:p-8">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      <div className="flex items-center justify-between">
                        <span className="text-base sm:text-lg font-bold text-gray-800">Starting from</span>
                        <span className="text-xl sm:text-2xl font-black text-emerald-600">₹999/mo</span>
                      </div>
                      
                      <Button 
                        onClick={() => handleBookNow(business)}
                        className="w-full bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-400 hover:to-blue-400 font-black py-2 sm:py-3 text-base sm:text-lg transition-all duration-300 transform hover:scale-105"
            ...
            <div className="text-center py-8 sm:py-12 md:py-16">
              <div className="text-4xl sm:text-6xl md:text-8xl mb-4" role="img" aria-label="Running person emoji">🏃‍♂️</div>
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-4">No businesses found</h3>
              ...
              <div className="flex gap-3 sm:gap-4 justify-center flex-col sm:flex-row px-2">
                ...
                <Link to="/register-trainer" className="w-full sm:w-auto">
      ...
      <section className="py-20 sm:py-24 md:py-28 bg-gradient-to-b from-gray-50 to-white relative" aria-labelledby="testimonials-heading">
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-2 bg-gradient-to-r from-[#106EBE] to-[#0FFCBE] rounded-full"></div>
        
        <div className="w-full px-3 sm:px-4 md:px-8 mx-auto max-w-7xl">
          <div className="text-center mb-16 sm:mb-20">
            <div className="mb-6 sm:mb-8 flex items-center justify-center">
              <Badge className="bg-green-100 text-green-700 px-6 sm:px-8 py-3 sm:py-4 text-xl sm:text-2xl font-black">
                ⭐ 25,000+ Life Transformations
              </Badge>
            </div>
            <h2 id="testimonials-heading" className="text-4xl sm:text-5xl md:text-7xl font-black text-gray-800 mb-6 sm:mb-8">
              Real Stories,
              <span className="block text-transparent bg-gradient-to-r from-[#106EBE] to-[#0FFCBE] bg-clip-text">
                Real Results
              </span>
            </h2>
            <p className="text-xl sm:text-2xl md:text-3xl text-gray-600 max-w-4xl mx-auto font-semibold leading-relaxed px-2">
      ...
      {/* FAQ Section */}
      <section className="py-20 sm:py-24 md:py-28 bg-white relative">
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-2 bg-gradient-to-r from-[#0FFCBE] to-[#106EBE] rounded-full"></div>
        <FAQSection />
      </section>
      ...
      {/* Enhanced Final CTA Section - Mobile Optimized */}
      <section className="py-20 sm:py-24 md:py-28 bg-gradient-to-r from-[#106EBE] to-[#0FFCBE] w-full relative overflow-hidden" aria-labelledby="final-cta-heading">
        {/* Background Elements */}
        <div className="absolute inset-0">
        ...
        <div className="relative w-full px-3 sm:px-4 md:px-8 mx-auto max-w-7xl text-center">
          <div className="max-w-6xl mx-auto text-white">
            {/* Super Urgency */}
            <div className="mb-6 sm:mb-8 flex items-center justify-center px-2">
              <div className="bg-red-500 text-white px-4 sm:px-8 py-3 sm:py-4 rounded-full flex items-center gap-2 sm:gap-3 animate-urgent text-lg sm:text-xl font-black shadow-2xl">
                <Clock3 className="h-5 w-5 sm:h-6 sm:w-6" />
                <span className="text-center">⚡ Last 48 Hours: FREE Trial + 50% OFF!</span>
              </div>
            </div>
            
            <h2 id="final-cta-heading" className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black mb-6 sm:mb-8 drop-shadow-2xl">
              Stop Waiting.
              <span className="block text-[#0FFCBE] drop-shadow-2xl text-3xl sm:text-4xl md:text-5xl lg:text-7xl mt-3 sm:mt-4">
                Start Living.
              </span>
            </h2>
            
            <p className="text-xl sm:text-2xl md:text-4xl mb-8 sm:mb-12 opacity-95 leading-relaxed font-bold max-w-4xl mx-auto px-2">
            ...
            <div className="flex flex-col gap-4 sm:gap-6 justify-center mb-8 sm:mb-10 px-2">
              <Link to="/signup" className="w-full sm:w-auto">
                <Button 
                  size="xl" 
                  className="bg-white text-[#106EBE] hover:bg-gray-100 font-black px-8 sm:px-16 py-6 sm:py-8 rounded-xl sm:rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 text-xl sm:text-2xl border-4 border-white/20 w-full sm:w-auto"
                >
                  🚀 Claim Your FREE Trial Now
                  <Badge className="ml-2 sm:ml-3 bg-red-500 text-white px-2 sm:px-3 py-1 text-sm sm:text-base animate-pulse">
                    50% OFF
                  </Badge>
                </Button>
              </Link>
              <Link to="/register-business" className="w-full sm:w-auto">
                <Button 
                  size="xl" 
                  variant="outline" 
                  className="border-4 border-white/70 text-white hover:bg-white/20 backdrop-blur-sm font-black px-8 sm:px-16 py-6 sm:py-8 rounded-xl sm:rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 text-xl sm:text-2xl bg-white/10 w-full sm:w-auto"
                >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 text-white/90 max-w-4xl mx-auto">
              <div className="flex flex-col items-center gap-1 sm:gap-2">
                <Shield className="h-6 w-6 sm:h-8 sm:w-8" />
                <span className="font-bold text-base sm:text-lg">100% Secure</span>
                <span className="text-xs sm:text-sm opacity-80">SSL Protected</span>
              </div>
              <div className="flex flex-col items-center gap-1 sm:gap-2">
                <Zap className="h-6 w-6 sm:h-8 sm:w-8" />
                <span className="font-bold text-base sm:text-lg">Instant Access</span>
                <span className="text-xs sm:text-sm opacity-80">Start Today</span>
              </div>
              <div className="flex flex-col items-center gap-1 sm:gap-2">
                <Award className="h-6 w-6 sm:h-8 sm:w-8" />
                <span className="font-bold text-base sm:text-lg">Premium Quality</span>
                <span className="text-xs sm:text-sm opacity-80">Verified Partners</span>
              </div>
              <div className="flex flex-col items-center gap-1 sm:gap-2">
                <Target className="h-6 w-6 sm:h-8 sm:w-8" />
                <span className="font-bold text-base sm:text-lg">Results Guaranteed</span>
                <span className="text-xs sm:text-sm opacity-80">Money Back</span>
              </div>
            </div>
          </div>
        </div>
