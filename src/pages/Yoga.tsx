...
const Yoga = () => {
  return (
    <>
      <SEOHead
        title="Best Yoga Studios & Classes in India | GymSpaYoga"
        description="Find authentic yoga studios in Mumbai, Delhi, Bangalore and across India. Hatha to Vinyasa classes with certified instructors."
