     ...
     <>
       ...
       <div className="min-h-screen bg-white">
         ...
         <section className="relative overflow-hidden h-[250px] md:h-[350px]">
           <div className="absolute inset-0">
             <OptimizedImage 
               ...
               alt="Professional chiropractor performing spinal adjustment"
           ...
           <div className="relative container mx-auto px-4 h-full flex items-center justify-center">
             <div className="max-w-4xl mx-auto text-center">
               ...
               <p className="text-base md:text-lg text-white/90 max-w-2xl mx-auto">
                 Professional spinal care and pain relief specialists near you
               </p>
             </div>
           </div>
         </section>
         ...
         <CategoryBusinesses
           ...
           title="Certified Chiropractors & Spine Specialists"
           description="Get relief from back pain, neck pain, and posture issues with our certified chiropractors and spine care specialists."
         />
 
         {/* Expert Chiropractors */}
         {/* Expert Chiropractors - Using generic trainers for now */}
             ...
             <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
               ...
               <div className="text-center lg:text-left flex-1 max-w-md">
                 ...
                 <p className="text-white/90 text-sm md:text-base">
                   Your Complete Wellness Destination. Find expert chiropractors today!
                 </p>
               </div>
