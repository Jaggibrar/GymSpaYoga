...
const Gyms = () => {
  ...
  return (
    <>
      <SEOHead
        title="Best Gyms in India — Find Gyms Near You | GymSpaYoga"
        description="Compare and book verified gyms in Mumbai, Delhi, Bangalore and across India. Modern equipment, expert trainers and flexible memberships."
