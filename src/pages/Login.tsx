...
const Login = () => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col items-start max-w-md mx-auto">
          ...
          <form onSubmit={isSignUp ? handleSignUp : handleLogin} className="w-full space-y-4">
            <input
              ...
              className="w-full p-3 bg-card text-foreground placeholder:text-muted-foreground border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary transition-colors"
              required
            />
      ...
      {/* Right Image Side */}
      <div className="w-full md:w-1/2 flex justify-center items-center p-10 bg-secondary/30">
        <img
